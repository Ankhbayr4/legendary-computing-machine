    ...
    <div className="flex flex-col gap-[25px]">
      <div className=" flex flex-1 gap-5  bg-gray-50 w-[1200px]  ">
        <div className="flex flex-col gap-6">
          ...
          <div>
            <p className="text-base font-normal">Email : info@jstemplate.net</p>
      ...
      <div className="flex justify-between">
        ...
        <div className="flex gap-4 items-center justify-center">
          ...
          <p className="text-base  text-gray-600 font-normal">Privacy Policy</p>
          <p className="border solid h-8"></p>
          <p className="text-base  text-gray-600 font-normal">Cookie Policy</p>
        </div>
      </div>
    </div>
  );
